; modified from the cffi code in the csound repo
...
(cffi:defcfun "csoundDestroyMessageBuffer" :void
  (csound :pointer))

(cffi:defcfun "csoundEnableMessageBuffer" :void
  (csound :pointer)
  (toStdOut :int))

(cffi:defcfun "csoundGetFirstMessage" :string
        (csound :pointer))

(cffi:defcfun "csoundGetFirstMessageAttr" :int
        (csound :pointer))

(cffi:defcfun "csoundGetMessageCnt" :int
        (csound :pointer))

(cffi:defcfun "csoundPopFirstMessage" :void
        (csound :pointer))

;
; from filebuilding.lisp
;
